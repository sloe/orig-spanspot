  ...
  {/if}
	...
	<table cellspacing="5">
	  <tr>
	    ...
	    <td>
	      <input type="text" style="width:100%" name="{g->formVar var="form[custName]"}" value="{if isset($form.custName)}{$form.custName}{/if}" size="50" />
	    </td>
	  ...
	  <tr>
	    ...
	    <td>
	      <input type="text" style="width:100%" name="{g->formVar var="form[custEmail]"}" value="{if isset($form.custEmail)}{$form.custEmail}{/if}" size="50" />
	    </td>
	  ...
	  <tr>
	    ...
	    <td>
	      <input type="text" style="width:100%" name="{g->formVar var="form[custSubject]"}" value="{if isset($form.custSubject)}{$form.custSubject}{/if}" size="50" />
	    </td>
