...
<script type="text/javascript" src="{g->url href='modules/flashvideo/lib/picker.js' forceFullUrl=true}"></script>
<div class="gbBlock gcBackground1">
  <h2> {g->text text="Flashvideo Settings"} </h2>
</div>
...
<div class="gbBlock">
  ...
  <tr>
    <td colspan="2">
      {g->text text="There are two colors used in the player's background gradiant."}
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <a href="javascript:TCP.popup(document.getElementById('color1'), '{g->url href='modules/flashvideo/lib/' forceFullUrl=true}')">
      <img width="16" height="16" border="0" alt="Color1" 
        title="Color1" src="{g->url href='modules/flashvideo/lib/cp.png' forceFullUrl=true}"></a>
    ...
    <td>
      ...
      <a href="javascript:TCP.popup(document.getElementById('color2'), '{g->url href='modules/flashvideo/lib/' forceFullUrl=true}')">
      <img width="16" height="16" border="0" alt="Color2" 
        title="Color2" src="{g->url href='modules/flashvideo/lib/cp.png' forceFullUrl=true}"></a>
  ...
  <tr>
    ...
    <td>
      ...
      <a href="javascript:TCP.popup(document.getElementById('color4'), '{g->url href='modules/flashvideo/lib/' forceFullUrl=true}')">
      <img width="16" height="16" border="0" alt="Fullscreen background color" 
        title="Fullscreen background color" src="{g->url href='modules/flashvideo/lib/cp.png' forceFullUrl=true}"></a>
  ...
  <tr>
    ...
    <td>
      ...
      <label for="cbAutoStart"> {g->text text="Play the video immediately?"} </label>
    </td>
  </tr>
  </table>
